...
import { clampMaxRows, discoverPeople, nameVariants, normaliseRor, parseList, validateOptions } from './discover.js?v=23';
import { peopleToCsv, peopleToJson, exportFilename, downloadText } from './exporters.js?v=23';
import { LANGS, t, setLang, getLang, resolveLang } from './i18n/index.js?v=23';
